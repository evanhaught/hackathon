      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap gap-4 justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <div className="bg-white p-1.5 rounded-lg shadow-sm hidden sm:block">
            <img 
              src="https://tse3.mm.bing.net/th/id/OIP.O-fu3BuCtJ2gL-yZhLEfQgHaF7?dpr=2&pid=ImgDetMain&o=7&rm=3$0" 
              alt="USF Bull" 
        ...
        {/* Center Controls - View Switcher (Visible to Everyone) */}
        <div className="flex bg-[#005036] p-1 rounded-lg border border-[#00402b] order-3 md:order-none w-full md:w-auto justify-center md:justify-start mt-2 md:mt-0">
          <button
            onClick={() => setViewMode('queue')}
            className={`flex items-center space-x-2 px-4 py-1.5 rounded-md text-sm font-medium transition-all duration-200 flex-1 md:flex-none justify-center ${
              viewMode === 'queue' 
